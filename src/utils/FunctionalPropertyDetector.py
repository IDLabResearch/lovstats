...
class FunctionalPropertyDetector(RestrictionTypeDetector):
    """
    This class serves as interface for all Restriction Type Statistics of functional properties expressions.
