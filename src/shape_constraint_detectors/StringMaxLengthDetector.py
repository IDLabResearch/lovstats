...
class StringMaxLengthDetector(RestrictionTypeDetector):
    """
    This class serves as interface for all shape constraint statistics of maximum length for literals.
    ...
    """
    def __init__(self):
        super(StringMaxLengthDetector, self).__init__()
        self.addResult(MEASURE_OCCURRENCE, 0, TYPE_INT)

    def getRestrictionType(self):
        return "stringMaxLength"

    def setNumberStringMaxLength(self, number):
