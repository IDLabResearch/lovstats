...
class CardinalityMaxCountDetector(RestrictionTypeDetector):
    """
    This class serves as interface for all shape constraint statistics of maximum cardinality constraints..
    ...
    """
    def __init__(self):
        super(CardinalityMaxCountDetector, self).__init__()
        self.addResult(MEASURE_OCCURRENCE, 0, TYPE_INT)

    def getRestrictionType(self):
        return "cardinalityMaxCount"

    def setNumberCardinalityMaxCount(self, number):
