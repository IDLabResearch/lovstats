...
class ShapePropertyDetector(RestrictionTypeDetector):
    """
    This class serves as interface for all shape constraint statistics of constraints for a property.
    ...
    def setNumberShapeProperty(self, number):
