...
class PropertyPairDisjointDetector(RestrictionTypeDetector):
    """
    This class serves as interface for all shape constraint statistics of disjoint property pair constraints.
    ...
    """
    def __init__(self):
        super(PropertyPairDisjointDetector, self).__init__()
        self.addResult(MEASURE_OCCURRENCE, 0, TYPE_INT)

    def getRestrictionType(self):
        return "propertyPairDisjoint"

    def setNumberPropertyPairDisjoint(self, number):
