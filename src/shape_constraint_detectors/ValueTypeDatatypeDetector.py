...
class ValueTypeDatatypeDetector(RestrictionTypeDetector):
    """
    ...
    """
    def __init__(self):
        super(ValueTypeDatatypeDetector, self).__init__()
        self.addResult(MEASURE_OCCURRENCE, 0, TYPE_INT)

    def getRestrictionType(self):
        return "valueTypeDatatype"

    def setNumberValueTypeDatatype(self, number):
